# SyncUI-Theme: Light & Dark Theme for ![@ImageGlass](https://github.com/ImageGlass)
...
A stylish, modern dual-tone theme designed to enhance your ![@ImageGlass](https://github.com/ImageGlass) experience. SyncUI offers both sleek dark and clean light variations, replacing default UI elements with 34+ minimalist Material Design icons. This theme creates a clean, focused environment that doesn't distract from your photos while maintaining perfect visual harmony across both modes.
## Features
...
- **Complete Compatibility:** Fully supports both ![@ImageGlass](https://github.com/ImageGlass) 9.0 and 8.3+ versions
